 ...
 * Deprecated: UI now reads only from the Canonical Read Model (V5 Plan).
 */
router.get('/sidebar-tickets', (req, res) => {
  res.status(410).json({ error: 'Endpoint deprecated. Use /workflow/inbox instead.' });
});
