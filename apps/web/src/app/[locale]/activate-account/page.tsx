...
function ActivateAccountForm() {
  ...
  if (!token) {
    return (
      <div style={{ textAlign: 'center' }}>
        <p style={{ fontSize: '16px', fontWeight: 600, color: '#F87171', marginBottom: '8px' }}>Invalid activation link</p>
        <p style={{ fontSize: '12px', color: 'var(--text-muted)' }}>The activation token is missing. Please use the link from your email.</p>
  ...
  return (
    <>
      <p style={{ fontSize: '20px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '4px' }}>Activate your account</p>
      <p style={{ fontSize: '12px', color: 'var(--text-muted)', marginBottom: '24px' }}>Set a password to complete onboarding</p>
