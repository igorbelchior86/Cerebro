...
- `/email-ingestion/list` now computes conservative heuristic suppression metadata for obvious noise categories (delivery bounces, quarantine digests, marketing promos).
